...
class Server(BaseException):
    ...
    def initialize_obstacles(self,imageDir,list_obstacles):
        i = 1
    ...
    def initialize_weights(self,imageDir):
        print(columns)
        print(rows)
...
if __name__== "__main__":
    ...
    for l in f.readlines():
        ...
        #print(goal_list)
    server.initialize_goal(images_directory,goal_list)
    f.close()
    # Defining the bomb ...
    ...
    for l in f.readlines():
        ...
        #print(bomb_list)
    server.initialize_bomb(images_directory,bomb_list,rows,columns)
    f.close()
    # Initialize the weights ...
    server.initialize_weights(images_directory)
    #root.update()
    # SERVER SERVER:
    # Starting server ...
